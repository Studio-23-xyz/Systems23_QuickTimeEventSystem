...
namespace Studio23.SS2.QTESystem.Data
{
	/// <summary>
	...
	public class QTEDataSO : ScriptableObject
	{
		...
		/// </summary>
		[InputControl(layout = "Button")] public List<string> ControlPath = new List<string>();
		...
		/// </summary>
		[EnableIf("IsBufferRequired")] public float ConcurrentInputBuffer = 0f;
